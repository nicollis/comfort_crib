...
ActiveRecord::Schema.define(version: 20170219044811) do
  ...
  add_index "profiles", ["guest_id"], name: "index_profiles_on_guest_id", using: :btree

  add_foreign_key "profiles", "guests"
end
